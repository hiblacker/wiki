...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/97312baddfb342128ffb9c205bedccac~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p>
...
插入前：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/601217fc64d141f0aed48f6558c53998~tplv-k3u1fbpfcp-zoom-1.image" alt="">
插入后：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/faf00f911dc04864ae52a6343dacafa2~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p>
<p>注意我圈红的地方，就是咱们要动手脚的地方。下面我用代码来表述一下这个改变。：</p>
<pre><code class="hljs language-js"><span class="hljs-comment">// 如果目标结点本来不存在，那么记得手动创建</span>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fc6a1f482c0c4b24bf791171c43167d9~tplv-k3u1fbpfcp-zoom-1.image" alt=""><br>
如此一来，node3 就成为了一个完全不可抵达的结点了，它会被 JS 的垃圾回收器自动回收掉。这个过程用代码表述如下：</p>
<pre><code class="hljs language-js">node1.next = node3.next 
</code></pre>
...
<pre><code class="hljs language-js"><span class="hljs-comment">// 利用 node1 可以定位到 node3</span>
...
但如果我们定义了不同类型的元素：</p>
<pre><code class="hljs language-js"><span class="hljs-keyword">const</span> arr = [<span class="hljs-string">'haha'</span>, <span class="hljs-number">1</span>, {<span class="hljs-attr">a</span>:<span class="hljs-number">1</span>}]
</code></pre>
